...
/*կոդը աշխատացնելու համար պետք է կոդը առտագրել .cpp ֆայլի մեջ
և compile անել
compile անելու համար պետք է հավաքել ստորև նշվաց հրամանը*/
`$ g++ <կոմպիլացիա լինող ֆայլի անունը>`
/*հրամանը հավաքելուց հետո նույն հասցեում ավելացնելու է a.out ֆայլը
աշխատացնելու համար պետք է հավաքել ստորև նշվաց հրամանը*/
՝$ ./a.out`
